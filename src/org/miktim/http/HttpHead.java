 ...
 * - fixed join method
 * 2023-10:
 * - functions join, listValues, setValues added
 *
 * Created: 2020-11-19
 */
...
public class HttpHead extends TreeMap<String, String> {
...
// Antonym of Java String.split method
    ...
    public HttpHead(Map map) {
        this();
        putAll(map);
        if(map instanceof HttpHead)
            this.startLine = ((HttpHead) map).startLine;
    }
